    ...
    <div className="bg-[#0a0a0a] text-white overflow-x-hidden">
      ...
      <section ref={heroRef} className="relative min-h-screen flex flex-col justify-center overflow-hidden">
        ...
        <motion.div style={{ opacity: heroOpacity }} className="relative z-20 px-6 md:px-16 max-w-2xl pt-8">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 border border-blue-500/40 bg-blue-500/10 text-blue-400 text-[10px] font-bold uppercase tracking-[0.25em] px-3 py-1.5 rounded-full mb-8"
          >
          ...
          <h1 className="text-[clamp(48px,7vw,88px)] font-black leading-[0.95] uppercase mb-8">
            {[
              ...
              { text: 'WORLD CUP', blue: true },
              { text: 'BETTER THAN', green: false },
            { text: 'EVERYONE?', blue: true },
              ...
              <motion.span
                ...
                className={`block ${line.blue ? 'text-blue-400' : 'text-white'}`}
              >
                {line.text}
              </motion.span>
            ))}
      ...
      <section className="py-20 px-6 md:px-16 bg-[#0a0a0a]">
        <FadeUp className="mb-10">
          <p className="text-blue-400 text-xs font-bold uppercase tracking-[0.3em] mb-2">World Cup 2026</p>
          ...
          {[
            ...
            <FadeUp key={step.n} delay={i * 0.1}>
              ...
              >
                {/* Glowing blue number */}
                <p
                  className="text-7xl font-black text-blue-400 mb-5 leading-none"
      ...
      <section className="py-20 px-6 md:px-16 bg-[#0d0d0d] border-t border-gray-800/50">
        <FadeUp className="max-w-4xl mx-auto">
          <p className="text-blue-400 text-xs font-bold uppercase tracking-[0.3em] mb-2">Scoring</p>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[
              ...
              >
                <p
                  className="text-6xl font-black text-blue-400 mb-3"
      ...
      <section className="py-20 px-6 md:px-16 bg-[#0d0d0d] border-t border-gray-800/50">
        <FadeUp className="max-w-2xl mx-auto">
          <p className="text-blue-400 text-xs font-bold uppercase tracking-[0.3em] mb-2">FAQ</p>
          ...
          <div className="divide-y divide-gray-800">
            {FAQS.map((faq, i) => (
              <div key={i}>
                ...
                >
                  <span className="font-bold text-white group-hover:text-blue-400 transition-colors uppercase tracking-wide text-sm">
                    {faq.q}
                  </span>
                  <motion.span
                    animate={{ rotate: openFaq === i ? 45 : 0 }}
                    transition={{ duration: 0.2 }}
                    className="text-blue-400 text-xl ml-4 flex-shrink-0"
                  >
                    +
                  </motion.span>
                </button>
      ...
      <section className="py-24 px-6 md:px-16 bg-[#0a0a0a] border-t border-gray-800/50 text-center">
        <FadeUp>
          <h2 className="text-4xl md:text-6xl font-black uppercase mb-6">
            Ready to <span className="text-blue-400">compete?</span>
          </h2>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            onClick={() => router.push('/squad')}
            className="inline-flex items-center gap-3 bg-blue-500 text-black font-black uppercase tracking-[0.2em] px-10 py-5 rounded-full text-sm transition-colors"
          >
            START COMPETING →
          </motion.button>
        </FadeUp>
